    ...
    <section class="sidebar">
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    [
                        'label' => '<span class="fa fa-angle-down"></span><span class="text-info">Planning</span>',
                        'url' =>['plan-versions/index'],
                    ],
                     [
                        'label' => '<span class="fa fa-angle-down"></span><span class="text-info">Budgeting</span>',
                        'url' =>'#',
                    ],
