...
class KipsUsersSearch extends KipsUsers {
    ...
    public function rules() {
        return [
            [['userid', 'class', 'gender', 'status'], 'integer'],
            [['firstname', 'surname', 'middlename', 'phone', 'email', 'username', 'password', 'date_of_birth', 'place_of_birth', 'religion', 'denomination', 'tribe','student_type','transport_route'], 'safe'],
        ];
    }
