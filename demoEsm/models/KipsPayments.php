 ...
 * @property integer $payment_set_up_id
...
class KipsPayments extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['id', 'student_id','status', 'financial_year_id','transport_route', 'receipt_number','student_class','payment_set_up_id'], 'integer'],
    ...
    public function attributeLabels() {
        return [
            ...
            'payment_set_up_id' => 'Payment setup',
    ...
    public function getPaymentSetUp() {
        return $this->hasOne(KipsPaymentSetup::className(), ['id' => 'payment_set_up_id']);
    }
