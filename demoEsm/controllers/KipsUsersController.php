...
class KipsUsersController extends Controller {
    ...
    public function actionIndex() {
        ...
        $condition = "user_type = 2 AND active = 1";
    ...
    public function actionView($id) {
        ...
        $studentPaymentsCondition =  "payment_setup_id IN (SELECT id FROM payment_setup WHERE payment_type IN (1,2)) AND student_id = " . $id;
