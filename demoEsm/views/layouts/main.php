    ...
    <body>
        ...
        <div class="wrap">
            ...
            $items[] = Yii::$app->user->isGuest ?
                    ...
                    ut (' . Yii::$app->user->identity->username . ')',
                'url' => ['/site/logout'],
...
<?= $content; ?> 
        ...
        <footer class="footer">
            <div class="container">
                &emsp;&emsp;&emsp;&emsp;&emsp;  <img src="../demo/images/logo.png" alt="Logo" height="102" width="102" style="position: absolute; top: 55px; right: 2%;" >
