...
//            'num_login_fail',
            ...
            [
                ...
                'format' => 'raw',
                'type' => DetailView::INPUT_DROPDOWN_LIST,
                'items' => ['1' => 'Day Student', '2' => 'Boarding Student'],
                'value' => $model->student_type == 1 ? 'Day Student' : 'Boarding Student',
            ],
            [
                'attribute' => 'transport_route',
                ...
                'value' => $model->transportRoute->area_covered,
            ],
        ],
        'deleteOptions' => [
...
//                },
                'value' => function($model) {
//                    $student_class = \app\models\KipsUsers::findOne(['userid' => $model->student_id]);
//                    return \app\models\KipsPaymentSetup::getStudentAmountPaid($model->student_id,$student_class->student_level,$student_class->student_type,1);
                },
                'hAlign' => 'right',
                'width' => '15%',
                'format' => ['decimal', 2],
