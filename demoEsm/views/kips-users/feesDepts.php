...
//                'value' => function ($model) {
//                    return \app\models\KipsPaymentSetup::getStudentAmountToBePaid($model->class, $model->student_type, 1);
//                },
//                'format' => 'raw',
//                'hAlign' => 'right',
//                'width' => '7%',
...
//                'value' => function ($model) {
//                    return \app\models\KipsPaymentSetup::getDeptAmountPaid(\app\models\KipsPaymentSetup::getPaymentSetupID(Yii::$app->session->get(mfy)->YearID, $model->class, 1, $model->student_type), $model->userid);
//                },
//                'format' => 'raw',
//                'hAlign' => 'right',
//                'width' => '7%',
